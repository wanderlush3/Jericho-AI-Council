...
def create_app() -> FastAPI:
    ...
    @application.get("/api/evolutions/active-overlays")
    ...
    @application.get("/api/evolutions/active-overlay/{target_id}")
    ...
    @application.put("/api/evolutions/{evolution_id}/overlay-status")
    ...
    @application.post("/api/evolutions/{evolution_id}/rollback")
    ...
    @application.post("/api/evolutions/rollback-to/{target_id}/{version_id}")
    ...
    @application.post("/api/evolutions/from-proposal/{proposal_id}")
